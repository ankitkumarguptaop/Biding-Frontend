...
import { Mail, Lock, Gavel, ArrowRight, Eye, EyeOff, CheckCircle, ShieldCheck } from 'lucide-react';
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>): void => {
    ...
    setTimeout(() => {
      ...
      if (formData.email && formData.password) {
        setMessage({
          type: 'success',
          text: 'Welcome back! Redirecting to auction floor...'
        });
      } else {
        ...
        <div className="md:w-1/2 bg-[#16161a] p-8 md:p-12 text-white flex flex-col justify-between relative overflow-hidden border-b md:border-b-0 md:border-r border-slate-800">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-10">
              ...
              <h1 className="text-2xl font-bold tracking-tight">BidMaster <span className="text-indigo-400">Pro</span></h1>
            </div>
            ...
            <p className="text-slate-400 text-lg max-w-sm leading-relaxed">
              Join thousands of collectors and investors in the world's most transparent bidding ecosystem.
            </p>
          </div>
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="mt-10 pt-8 border-t border-slate-800/50">
              ...
              <div className="flex justify-center items-center gap-8 grayscale opacity-30 contrast-125">
                ...
                <span className="font-sans text-lg font-black text-white">Artnet</span>
              </div>
            </div>
          </div>
        </div>
